...
More information about Manifest file can be found in the [ENA Assembly submission documentation](https://ena-docs.readthedocs.io/en/latest/submit/general-guide/webin-cli.html).
